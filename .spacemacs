...
(defun ndu/get-priority-match ()
  (setq input (read-from-minibuffer "Priority (A-E):"))
  (if (member input '("A" "B" "C" "D" "E"))
      (concat "+PRIORITY=" "\"" input "\"")
      nil))
...
(defun ndu/org-drill ()
 (require 'org-drill)
 (interactive)
 (org-drill nil (ndu/get-priority-match)))
(defun ndu/org-cram ()
 (require 'org-drill)
 (interactive)
 (org-drill-cram nil (ndu/get-priority-match)))
(defun ndu/org-drill-tree ()
 (require 'org-drill)
 (interactive)
 (org-drill 'tree (ndu/get-priority-match)))
(defun ndu/org-cram-tree ()
 (require 'org-drill)
 (interactive)
 (org-drill-cram 'tree (ndu/get-priority-match)))
