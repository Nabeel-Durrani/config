...
;; 18/04/2001 - Going with Kris' "new tyle" look up code.  It's excellent.
;;            - Load tags from URL.
...
(defcustom doxymacs-external-xml-parser-executable
  "/home/ndurrani/bin/doxymacs_parser"
...
(defconst doxymacs-JavaDoc-file-comment-template
 '("/**" > n
   ...
   " * " (doxymacs-doxygen-command-char) "date   " (shell-command-to-string "echo -n $(date +%d-%m-%Y)") > n
...
(defconst doxymacs-Qt-file-comment-template
 '("/*!" > n
   ...
   > n
   " " (doxymacs-doxygen-command-char) "date   " (calendar-current-date) > n
   " " > n
   " " (doxymacs-doxygen-command-char) "brief  " (p "Brief description of this file: ") > n
   " " > n
   " " p > n
